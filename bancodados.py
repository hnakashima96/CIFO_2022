...
def create_table_perform():
    ...
    cursor = conn.cursor()
    sql = "DROP TABLE IF EXISTS PERFORM; CREATE TABLE PERFORM (COMBINATION VARCHAR(25), TEST_NUMBER VARCHAR(25),TIME VARCHAR(25), POP_SIZE VARCHAR(25), SELECTION VARCHAR(25), CROSSOVER VARCHAR(25), CROSSOVER_PERCENT VARCHAR(25), MUT_PERCENT VARCHAR(25), ELITISM_PERCENT VARCHAR(25))"
