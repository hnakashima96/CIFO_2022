...
def create_table_perform():
    ...
    cursor = conn.cursor()
    sql = "CREATE TABLE PERFORM (COMBINATION VARCHAR(25), TEST_NUMBER VARCHAR(25),TIME VARCHAR(25), POP_SIZE VARCHAR(25), SELECTION VARCHAR(25), CROSSOVER VARCHAR(25), CROSSOVER_PERCENT VARCHAR(25), MUT_PERCENT VARCHAR(25))"
...
def create_table_analysis(selection, co_option):
    ...
    query = "CREATE TABLE " + nome + " (TEST_NUMBER VARCHAR(25), COUNT VARCHAR(25),FITNESS VARCHAR(25),DIVERSITY VARCHAR(25))"
